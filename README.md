# Bedienungsanleitung: Online-Portal zum Ausbildersprechtag


# Einleitung und Systemübersicht
**Handbuch für Lehrkräfte der Theobald-Simon-Schule Bitburg**

Der Ausbildersprechtag an der Theobald-Simon-Schule Bitburg ist ein zentrales Instrument zur För­derung des Dialogs zwischen der Berufsschule und den dualen Ausbildungsbetrieben. Um die Orga­nisation dieses Austauschs – analog zum klassischen Elternsprechtag – effizient, transparent und zeitsparend zu gestalten, wird eine webbasierte Anwendung eingesetzt.
...
git clone https://github.com/kaykoch/Ausbildersprechtag.git # Herunterladen der App
...
```python
APP_NAME = (
    "sprechtag"  # beliebiger Name für die Applikation. Dient nur zur Unterscheidung bei mehreren GuniCorn Anwendungen
)
...
# Ablauf für Lehrkräfte (Ihre Perspektive)
...
2. Füllen Sie die Pflichtfelder auf der Registrierungsseite aus:
   ...
   - **Vorname & Nachname:** Tragen Sie ![]()hier Ihre vollständigen Namensdaten ein.
...
- **Buchungen: Einsicht in alle Buchungen erhalten sie mit der Schaltfläche Buchungen. ()**
...
- ![]()**PDF-Export der Terminliste:** Um am Sprechtag selbst eine ausgedruckte oder digitale Übersicht parat zu haben, klicken Sie unterhalb der Tabelle auf die blaue Schaltfläche **\[pdf - Download\]**. Das System erzeugt daraufhin eine übersichtliche PDF-Terminliste, welche Ihren Namen, den zugewiesenen Raum sowie die chronologische Tabelle der angemeldeten Betriebe enthält.
![Screenshot der Anwendung](./src/static/images/lehrkraft_PDF.png)

# Ablauf für Ausbildungsbetriebe (Ausbilder-Perspektive)
...
Die Ausbildungsbetriebe erhalten die spezifische Webadresse für die Anmeldung über die Schülerinnen und Schüler. Die Auszubildenden leiten die URL direkt an ihre jeweiligen Ausbilder im Betrieb weiter.

## Terminauswahl und Datenübermittlun![]()g
...
2. ![]()**Zeitfenster wählen:** Im daneben stehenden Dropdown-Menü *„Wann möchten Sie mit der Lehrkraft sprechen?“* werden dynamisch alle noch freien Uhrzeiten der ausgewählten Lehrkraft angezeigt. Bereits belegte Zeiten sind automatisch ausgeblendet. ()
